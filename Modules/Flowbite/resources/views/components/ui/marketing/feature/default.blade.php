<section class="py-2 lg:py-10">
    ...
    >
        <div>
            <div
                class="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900"
            >
                <svg
                    class="h-5 w-5 text-blue-600 lg:h-6 lg:w-6 dark:text-blue-300"
                    fill="currentColor"
                    viewBox="0 0 20 20"
