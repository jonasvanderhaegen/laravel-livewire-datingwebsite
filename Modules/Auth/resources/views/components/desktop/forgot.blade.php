    ...
    <x-slot name="topLeft">
        ...
        >
            <fieldset :disabled="remaining > 0" class="space-y-4 md:space-y-6">
                ...
                <button
                    type="submit"
                    class="cursor pointer w-full rounded-full bg-blue-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-500 focus:ring-4 focus:ring-blue-300 focus:outline-none disabled:opacity-50 dark:bg-blue-500 dark:hover:bg-blue-500 dark:focus:ring-blue-800"
                >
